 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Up   |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Down |  Alt | GUI  | RAlt |Lower |    Space    |Raise | Shift| Ctrl | Left |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_plaid_grid(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_UP,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
    KC_DOWN, KC_LALT, KC_RGUI, KC_RALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LSFT, KC_LCTL, KC_LEFT, KC_RGHT
),
...
[_COLEMAK] = LAYOUT_plaid_grid(
    ...
    KC_UP,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
    KC_DOWN, KC_LALT, KC_RGUI, KC_RALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LSFT, KC_LCTL, KC_LEFT, KC_RGHT
),
...
[_DVORAK] = LAYOUT_plaid_grid(
    ...
    KC_UP,   KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_ENT ,
    KC_DOWN, KC_LALT, KC_RGUI, KC_RALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LSFT, KC_LCTL, KC_LEFT, KC_RGHT
),
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Home |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |ISO ~ |ISO | | Next | Play |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | End  |      |      |      |      |             |      |      |      | Vol- | Vol+ |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_plaid_grid(
    ...
    KC_HOME, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_MNXT, KC_MPLY, _______,
    KC_END,  _______, _______, _______, _______, _______, _______, _______,    _______,    _______, KC_VOLD, KC_VOLU
),
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |Pg Up |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |ISO # |ISO / | Next | Play |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Pg Dn |      |      |      |      |             |      |      |      | Vol- | Vol+ |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_plaid_grid(
    ...
    KC_PGUP, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_MNXT,  KC_MPLY, _______,
    KC_PGDN, _______, _______, _______, _______, _______, _______, _______, _______,  _______, KC_VOLD, KC_VOLU
),
 ...
 * |      |      |      |      |      |      |      |      |      |      |      | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |Caps  |      |      |Aud on|Audoff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|      | Ins  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |Voice-|Voice+|Mus on|Musoff|MIDIon|MIDIof|      |PrnScr|ScrLck|Pause |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Reset |      |      |      |      |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_plaid_grid(
    _______, LED_1,   LED_2,   LED_3,   LED_4,   LED_5,   LED_6,   LED_7,   LED_8,   LED_9,   LED_0,   KC_DEL,
    KC_CAPS, XXXXXXX, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  XXXXXXX, KC_INS,
    _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  XXXXXXX, KC_PSCR, KC_SCRL, KC_PAUS, _______,
