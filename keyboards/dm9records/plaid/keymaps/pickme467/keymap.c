...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FUNCTIONS] = LAYOUT_plaid_grid(
    ...
    KC_CLCK,   KC_SLCK,   XXXXXXX,   XXXXXXX,    KC_F11,   XXXXXXX,   XXXXXXX,    KC_F12,   XXXXXXX,   KC_PGUP,   XXXXXXX,   XXXXXXX,
  ...
  XXXXXXX,   XXXXXXX,   KC_VOLU,   KC_MUTE,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,    MC_SU1,   XXXXXXX,    XXXXXXX,   XXXXXXX,
