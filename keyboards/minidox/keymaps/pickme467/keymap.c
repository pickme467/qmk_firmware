...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      KC_CLCK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       FN_LK1,  FN_LK4, XXXXXXX, XXXXXXX,  KC_ENT,\
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
       KC_TAB,  KC_DOT,  KC_EQL, KC_UNDS, KC_MINS,                      KC_SLSH, KC_BSLS, KC_PLUS, KC_QUES, KC_BSPC,\
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
       KC_ESC, KC_COMM, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_RCTL, KC_PIPE, KC_TILD,  KC_GRV,  KC_ENT,\
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                 KC_LGUI, KC_LCTL, XXXXXXX,    KC_LALT, KC_RGUI, KC_RSFT\
                             //`--------------------------'  `--------------------------'
  ),
